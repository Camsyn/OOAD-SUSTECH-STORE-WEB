    ...
    actions: {
        selectReportRecord(context, t_id=null) {
            return new Promise((resolve, reject)=>{
                selectReportRecord(t_id).then(res=>resolve(res)).catch(err=>console.log(err));
            });
        },

        selectReportsAboutUser(context, t_id) {
            return new Promise((resolve, reject)=>{
                selectReportsAboutUser (t_id).then(res=>resolve(res)).catch(err=>console.log(err));
            });
        },

        reportUser(context, {t_id, desc}) {
            return new Promise((resolve, reject)=>{
                reportUser(t_id, desc).then(res=>resolve(res)).catch(err=>console.log(err));
            });
        },

        reportOrder(context, {t_id, desc}) {
            return new Promise((resolve, reject)=>{
                reportOrder(t_id, desc).then(res=>resolve(res)).catch(err=>console.log(err));
            });
        },
        reportChat(context, {t_id, desc}) {
            return new Promise((resolve, reject)=>{
                reportChat(t_id, desc).then(res=>resolve(res)).catch(err=>console.log(err));
            });
        },
        reportCircle(context, {t_id, desc}) {
            return new Promise((resolve, reject)=>{
                reportCircle(t_id, desc).then(res=>resolve(res)).catch(err=>console.log(err));
            });
        },
        ...
        argue(context, {R_id, desc}) {
            return new Promise((resolve, reject)=>{
                reportCircle(R_id, desc).then(res=>resolve(res)).catch(err=>console.log(err));
            });
        },
    }
}
